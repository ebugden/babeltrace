    ...
    forEachMipVersion([&](const std::uint64_t graphMipVersion) {
        ...
        if (graphMipVersion == 0) {
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with a Unix epoch origin followed by clock class with unknown origin",
                "Expecting a clock class with a Unix epoch origin, got one with unknown origin");
            ...
            cases.emplace_back(
                ...
                noClockClass, graphMipVersion,
                "clock class with unknown origin and a UUID followed by no clock class",
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with unknown origin and a UUID followed by clock class with a Unix epoch origin",
                "Expecting a clock class with unknown origin and a specific UUID, got one with a Unix epoch origin");
            ...
            cases.emplace_back(
                ...
                noClockClass, graphMipVersion,
                "clock class with known origin followed by no clock class",
                "Expecting a clock class with known origin, got none");
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with known origin followed by clock class with unknown origin",
            ...
            cases.emplace_back(
                ...
                noClockClass, graphMipVersion,
                "clock class with unknown origin and an identity followed by no clock class",
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with unknown origin and an identity followed by clock class with known origin",
                "Expecting a clock class with unknown origin and a specific identity, got one with known origin");
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with unknown origin and an identity followed by clock class with unknown origin and no identity",
                "Expecting a clock class with unknown origin and a specific identity, got one without identity");
            ...
            cases.emplace_back(
                ...
                graphMipVersion,
                "clock class with unknown origin and an identity followed by clock class with unknown origin and another identity",
                "Expecting a clock class with unknown origin and a specific identity, got one with a different identity");
        }
        ...
        cases.emplace_back(
            ...
            noClockClass, graphMipVersion,
            "clock class with unknown origin and no UUID/identity followed by no clock class",
        ...
        cases.emplace_back(
            ...
            graphMipVersion,
            "clock class with unknown origin and no UUID/identity followed by different clock class",
