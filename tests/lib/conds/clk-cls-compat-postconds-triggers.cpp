...
const std::string namespaceA = "namespace-a";
const std::string nameA = "name-a";
const std::string uidA = "uid-a";
const std::string namespaceB = "namespace-b";
const std::string nameB = "name-b";
const std::string uidB = "uid-b";
...
void addClkClsCompatTriggers(CondTriggers& triggers)
{
    const auto addValidCases = [&triggers](
                                   ...
                                   const char * const condId, uint64_t graphMipVersion) {
        /*
    ...
    forEachMipVersion([&](const uint64_t graphMipVersion) {
        addValidCases(
            {},
    ...
    // addValidCases(
    //     [mip](const bt2::SelfComponent self) {
    //         const auto clockCls = self.createClockClass();

    //         if (mip == 0) {
    //             clockCls->originIsUnixEpoch(false).uuid(uuidA);
    //         } else {
    //             clockCls->origin(namespaceA, nameA, uidA);
    //         }
    ...
    //         } else {
    //             clockCls->origin(namespaceB, nameB, uidB);
    //         }

    //         return clockCls;
    //     },
    //     "message-iterator-class-next-method:clock-class-has-expected-uuid", mip);
    ...
    //         return clockCls;
    //     },
    //     {}, "message-iterator-class-next-method:stream-class-has-clock-class", mip);
    ...
    //         return clockCls;
    //     },
    //     "message-iterator-class-next-method:clock-class-is-expected", mip);
}
