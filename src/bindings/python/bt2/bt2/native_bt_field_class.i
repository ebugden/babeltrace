 ...
 * values to be truncated to `int`Pyconstants casts values to `int`.
 * For `bt_field_class_type`, we need more than 32 bits.  Use this
 * custom typemap to avoid truncation.
 */
