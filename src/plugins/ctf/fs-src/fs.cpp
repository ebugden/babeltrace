                                  ...
                                  bt_integer_range_set_unsigned *supportedVersions)
{
    try {
        ...
        if (ctf_fs->trace->metadataVersion() == ctf::src::MetadataStreamMajorVersion::V1) {
            bt2::wrap(supportedVersions).addRange(0, 1);
        } else {
            BT_ASSERT(ctf_fs->trace->metadataVersion() == ctf::src::MetadataStreamMajorVersion::V2);
            bt2::wrap(supportedVersions).addRange(1, 1);
        }
