...
#define CC_ORIGIN_FMT(_prefix) \
	_prefix "expected-cc-origin-ns=%s, " \
	_prefix "expected-cc-origin-name=%s, " \
	_prefix "expected-cc-origin-uid=%s"
...
#define CC_ID_FMT(_prefix) \
	_prefix "expected-cc-ns=%s, " \
	_prefix "expected-cc-name=%s, " \
	_prefix "expected-cc-uid=%s"
...
#define EXP_CC_ID_VALUES CC_ID_VALUES(ref_clock_cls)
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_KNOWN_GOT_NONE:
			if (graph_mip_version == 0) {
				...
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
					...
					"Expecting a clock class with known origin, got none: " EXP_CC_ORIGIN_FMT,
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_KNOWN_GOT_UNKNOWN:
			if (graph_mip_version == 0) {
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_KNOWN_GOT_WRONG:
			BT_ASSERT(graph_mip_version > 0);
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"clock-class-has-expected-origin", false,
				"Expecting a clock class with specific origin: %![cc-]+K, " EXP_CC_ORIGIN_FMT,
				actual_clock_cls, EXP_CC_ORIGIN_VALUES);

		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_ID_GOT_NONE:
			if (graph_mip_version == 0) {
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				...
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
					...
					"Expecting a clock class with unknown origin and a specific identify, "
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_ID_GOT_KNOWN:
			if (graph_mip_version == 0) {
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				...
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
					"clock-class-has-unknown-origin", false,
					"Expecting a clock class with unknown origin and a specific identity, "
					"got one with known origin: %![cc-]+K, " EXP_CC_ID_FMT,
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_ID_GOT_WITHOUT:
			if (graph_mip_version == 0) {
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				...
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
					...
					"Expecting a clock class with unknown origin and a specific identity, "
					"got one without identify: %![cc-]+K, " EXP_CC_ID_FMT,
					actual_clock_cls, EXP_CC_ID_VALUES);
			}
			/*
			 * gcc gives bogus '-Wimplicit-fallthrough'
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_ID_GOT_WRONG:
			if (graph_mip_version == 0) {
				BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITHOUT_ID_GOT_NONE:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"stream-class-has-clock-class", false,
				"Expecting a clock class, got none: %![expected-cc-]+K",
				ref_clock_cls);

		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITHOUT_ID_GOT_WRONG:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
