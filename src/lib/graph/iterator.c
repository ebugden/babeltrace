		...
		const struct bt_message *msg)
{
	...
	if (!bt_clock_correlation_validator_validate_message(
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNIX_GOT_UNKNOWN:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"clock-class-has-unix-epoch-origin", false,
				"Expecting a clock class with Unix epoch origin: %![cc-]+K",
				actual_clock_cls);
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_UUID_GOT_NONE:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"stream-class-has-clock-class-with-uuid", false,
				"Expecting a clock class, got none.");
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_UUID_GOT_UNIX:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"clock-class-has-non-unix-epoch-origin", false,
				"Expecting a clock class without Unix epoch origin: %![cc-]+K",
				actual_clock_cls);
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_UUID_GOT_WITHOUT:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"clock-class-has-uuid", false,
				"Expecting a clock class with UUID:  %![cc-]+K",
				actual_clock_cls);
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITH_UUID_GOT_WRONG:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
		...
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITHOUT_UUID_GOT_NONE:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
				"stream-class-has-clock-class", false,
				"Expecting a clock class, got none.");
		case BT_CLOCK_CORRELATION_VALIDATOR_ERROR_TYPE_EXPECTING_ORIGIN_UNKNOWN_WITHOUT_UUID_GOT_WRONG:
			BT_ASSERT_POST_DEV(NEXT_METHOD_NAME,
